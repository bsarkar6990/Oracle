...
SELECT   MP.ORGANIZATION_CODE,
        ...
        src.ORGANIZATION,src.ASSET_GROUP,src.ASSET_NUMBER,src.ASSET_DESC,
        src.ASSET_CATEGORY_MAJOR,src.ASSET_CATEGORY_MINOR,src.ASSET_SERIAL_NUM,src.OWNING_DEP,
        src.CRITICALITY, src.WIP_ACCOUNT_CLASS,src.AREA, src.WARRANTY_EXP,
        src.PARENT_ASSET_NUMBER, src.FIXED_ASSET_NUM, src.LOCATION_CODE, src.Asset_type
FROM    mtl_serial_numbers msn,
        csi_item_instances cii,
        atp_rebuild@PDSEBS2DPPRD src,
        mtl_parameters  mp,
